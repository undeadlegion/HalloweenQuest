...
export default class TitleScene extends Phaser.Scene {
  constructor (key) {
    ...
    create(){
        ...
        let startBtn = this.add.image(340, 320, "startbutton").setOrigin(0).setDepth(1);
        ...
        let text = this.add.text(80, 520, story_text, { fontFamily: 'Courier New', fontSize: '14pt', color: '#ffff00', wordWrap: { width: 680 } }).setOrigin(0).setDepth(2);
        text.setMask(mask);
